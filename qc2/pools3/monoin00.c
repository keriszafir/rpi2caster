     ...
     */
	  ...
	  if ( um > uit ) um = uit;
       ...
       if ( nl < 6  ) {
	     ...
	     /*
	     print_at(12,0,"less than 6 units left\n");
	     if ( un1 < 8 ) {
		printf("variable spaces %2d  correction %2d / %2d = %8.5f \n",
		   line_data.nspaces, un1, un2,
		   wig[0] + (un1*15+un2-53)*2.592/central.set
		   );
	     } else {
		printf("variable spaces %2d  correction %2d / %2d = %8.5f \n",
		   line_data.nspaces, un1, un2,
		...
		case '@' :
		   ...
		   } /* negeren commando vlak uitvullen */
		   break;
		default :
		   break;
	     }
	   ...
	   print_at(0,0,"");
     printf("line %3d left: %3d units vars: %2d just: %2d/%2d  = %10.6f units",
		      (aantal_lines + 1),
		      nl,
		      line_data.nspaces,
		      un1, un2 ,
	   ...
	   /*
		    wig[1] + (un1*15+un2-53)*2.592/central.set;
			  5.184 )/  ;
	    */

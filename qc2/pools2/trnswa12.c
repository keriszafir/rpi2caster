...
/***************   #include <c:\qc2\pools2\moninc10.c>  *****************/
...
/***************   #include <c:\qc2\pools2\monolus.c>   *****************/
...
/*
   #include <c:\qc2\pools2\walb10.c>
*/
   #include <c:\qc2\pools2\walb12.c>
/*
...
{
   sti=0;
   while ( outtextbuffer[sti] != '\0' && sti < outb_n && sti < BUFSIZ ) {
...
int aantal_lines;
#include <c:\qc2\pools2\testedit.c>
...
#include <c:\qc2\pools2\monoin00.c>
/* testzoek5 */

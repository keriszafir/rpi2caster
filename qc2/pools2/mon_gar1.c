...
FILE     *fintext;               /* pointer text input-file */
...
char          outmin; /* ' ' negeren = ' '
			 ...
			 '#' niets doen
*/
unsigned char reinde; /* ^CR = 0, ^CC = 1, ^Cl = 2 ^CF = 3 */
...
struct regel_data {
    ...
    unsigned char u1;       /* uitvulling regel 0075 */
    unsigned char u2;       /* uitvulling regel 0005 */

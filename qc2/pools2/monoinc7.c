...
void pri_lig( struct matrijs *m )
{
   ...
   lengte bepalen van de ligatuur
    */
   for (prii = 0 ; prii<3 ; prii++) {
      if ( m -> lig[prii] ) {
	printf("%1c",m -> lig[prii] );
      }
      else {
	printf(" ");
      }
...
void intro1(void)
{
     ...
     print_at( 4,35,"version 8.2.0.0");
     print_at( 6,35,"june 2008");
     print_at( 8,34,"John Cornelisse");
     print_at( 9,35,"Enkidu-Press");
     print_at(10,34,"23 Vaartstraat");
     print_at(11,32,"4553 AN Philippine");
     print_at(12,33,"Zeeuws Vlaanderen");
     print_at(13,34,"The Netherlands");
     print_at(14,23,"email: enkidu1947@live.nl");
     print_at(15,27,"tel  : +31 (0) 6 555 73 800");
...
void intro(void)
{
     ...
     cls();
     print_at( 2,31,      "MONOTYPE Coding Program");
     print_at( 4,38,             "reading ");
     print_at( 5,35,          "the essentials");
     print_at( 6,31,      "from character and text");
     print_at( 9,34,         "line-width in:");
     print_at(11,35,          "Pica's   = p");
     print_at(12,35,          "Didot    = d");
     print_at(13,35,          "Fournier = f");
     do {
	print_at(15,46,                  "   ");
	print_at(15,35,       "width in : ");
	get_line();
	ntrcx = line_buffer[0];
	if ( ntrcx =='#') exit(1);
     }
	...
	fixed_space();
     ...
     /*
     printf("\nin intro: Central.inchwidth %8.4f",central.inchwidth);
     if (getchar()=='#')exit(1);
      */

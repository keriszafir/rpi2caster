...
"!",2, 7, 4, 14,
    /* <<          >> */
"\256",1,9,4,1, "\257",1,9,4,3,
"\256",2,9,4,1, "\257",2,9,4,3,
...
"\214",0,5, 0, 5,  "j" ,0,5, 0, 6, "i",0,5, 0, 7, " ",0,5, 0, 8,"l",0,5, 0, 9,
	       /* i^ */
".",0,5, 0,10,  ",",0,5, 0,11,  "\'",0,5, 0,12, "(",0,7, 0,13, "i",4,5, 0,14,
"l",4,5, 0,15,  "t",4,5, 0,16,

 /* c! */        /* e` */          /* e' */
"\207",1,6, 1, 0, "\212",1,6, 1, 1, "\202",1, 6,1,2, "c",1,6, 1, 3, "f",1,6, 1, 4,
"t",1,6, 1, 5,   "-",0,6, 1, 6, "e",1,6, 1, 7," ",1,6, 1, 8, "f",0,6, 1, 9,
					     /* >> */
"t",0,6, 1,10, "s",1,6, 1,11, ")",0,7, 1,12, "r",4,9, 1,13, "s",4,8, 1,14,
/* e^ */
"\210",1,6, 1,15, "/",0,6, 1,16,

			       /* o" */
"v",1,7, 2, 0, "y",1,7, 2, 1, "g",1,7, 2, 2, "r",1,7, 2, 3, "o",1,7, 2, 4,
"!",0,6, 2, 5, "I",0,7, 2, 6, "r",0,7, 2, 7, "s",0,7, 2, 8, ":",0,5, 2, 9,
							 /* ì 93 223 */
";",0,5, 2,10, "o",4,6, 2,11, "e",4,6, 2,12, "[",0,6, 2,13, "\223",1,6, 2,14,
"j",2,8, 2,15, "s",2,8, 2,16,


"b",1,8, 3, 0, "q",1,8, 3, 1, "n",1,8, 3, 2, "d",1,8, 3, 3, "h",1,8, 3, 4,
		/* c! */
"u",1,8, 3, 5, "a",1,8, 3, 6, "c",0,8, 3, 7, "a",0,8, 3, 8, "e",0,8, 3, 9,
	      /* e' */          /* e`*/          /* a` */          /* a^ */
"z",0,8, 3,10, "\202",0,8, 3,11, "\212",0,8, 3,12, "\205",0,8, 3,13, "\203",0,8, 3,14,
/* e^ */
"\210",0,8, 3,15, "\207",0,8, 3,16,

":",1,9, 4, 0,  ";",1,9, 4, 1, "fi",1,9, 4, 2, "3",0,9, 4, 3, "6",0,9, 4, 4,
"9",0,9, 4, 5, "5",0,9, 4, 6, "8",0,9, 4, 7, " ",2,9, 4, 8, "p",1,9, 4, 9,
	      /* << */                                       /* >> */
"J",0,9, 4,10, "\256",0,9, 4,11, "?",0,9, 4,12, "``",0,9, 4,13, "\257",0,9, 4,14,

"\205",1,8, 4,15, "\243",0,8, 4,16,


"J", 1,9, 5, 0, "I",1,9, 5, 1, "fl",1,9, 5, 2, "7",0,9, 5,3, "4",0,9, 5, 4,
"1", 0,9, 5, 5, "0",0,9, 5, 6, "2",0,9, 5, 7, "z",1,9, 5, 8, "oe!",1,9, 5, 9,
							      /* u` */
"x", 0,9, 5,10, "y",0,9, 5,11, "--",0,9, 5,12, "\'\'",0,9, 5,13, "\227",0,9, 5,14,
/* a^                u" */
"\203",1,9, 5,15, "\201", 1,9, 5,16,
						/* u" */          /* u^ */
"!",1,10, 6, 0, "?",1,10, 6, 1, "ff",1,10, 6, 2, "\201",0,10, 6, 3, "\226",0,10,6,4,
/* u` */
"\227",0,10, 6, 5, "q",0,10, 6, 6, "p",0,10, 6, 7, "g",0,10, 6, 8, "b",0,10, 6, 9,
"d",0,10, 6,10, "v",0,10, 6,11, "S",0,10, 6,12, "a",2,10, 6,13, "c",2,10, 6,14,

"o",2,10, 6,15, "q",2,10, 6,16,
			      /* ë 91 221 */                     /* c! */
"x",2,10, 7, 0, "S",1,10, 7, 1, "\221",1,10, 7, 2, "k",1,10, 7, 3, "\207",2,10, 7, 4,
/* ì 93 223 */
"\223",0,10, 7, 5, "n",0,10, 7, 6, "o",0,10, 7, 7, "u",0,10, 7, 8, "h",0,10, 7, 9,

"k",0,10, 7,10, "ff",0,10, 7,11, "fi",0,10, 7,12, "fl",0,10, 7,13,
			       /* ¢ a2 242 */
"u",2,10, 7,14, "r",2,10, 7,15, "\242",0,10, 7,16,

							    /* +!*/
"",1,11, 8, 0, "",1,11, 8, 1, "F",0,11, 8, 2, "P",0,11, 8, 3, "",0,11, 8, 4,
					       /* ae! */
"w",1,11, 8, 5, "x",1,11, 8, 6, "*",0,11, 8, 7, "\221",0,11, 8, 8, "d",2,11, 8, 9,

"g",2,11, 8,10, "n",2,11, 8,11, "k",2,11, 8,12, "",1,11, 8,13, "",0,11, 8,14,
"",0,11, 8,15, "",0,11, 8,16,

"",0,12, 9, 0, "",0,12, 9, 1, "",0,12, 9, 2, "",0,12, 9, 3, "T",1,12, 9, 4,
"Z",1,12, 9, 5, "Lb",1,12, 9, 6, "B",0,12, 9, 7, "C",0,12, 9, 8, "L",0,12, 9, 9,
/* C-cedille */
"\200",0,12, 9,10, "m",4,12, 9,11, "h",2,12, 9,12, "m",2,12, 9,13, "",0,12, 9,14,
"",1,10, 9,15, "",0,12, 9,16,

"",0,13,10, 0, "Y",1,13,10,1, "ffi",1,13,10, 2, "ffl",1,13,10, 3, "B",1,13,10, 4,
"P",1,13,10, 5, "", 1,13,10, 6, "m",1,13,10, 7, "oe!",0,13,10, 8, "E",0,13,10, 9,
								 /*E'*/
"R",0,13,10,10, "T",0,13,10,11, "Z",0,13,10,12, "",1,14,10,13, "\220",0,14,10,14,
/*  E`          E^ */
"\324",0,13,10,15, "\322",0,13,10,16,

"F",1,14,11, 0, "L",0,14,11, 1, "R",1,14,11, 2, "V",0,14,11, 3, "Y",0,14,11, 4,
"A",0,14,11, 5, "U",0,14,11, 6, "w",0,14,11, 7, "\221",2,14,11, 8, "w",2,14,11, 9,
"O",1,14,11,10, "Q",1,14,11,11, "C",1,14,11,12, "K",1,14,11,13, "",1,14,11,14,
	      /*C!*/
"",1,14,11,15, "\200",1,14,11,16,

"G",1,15,12, 0,    "U",1,15,12, 1, "E",1,15,12,2, "Q",0,15,12,3, "X",0,15,12, 4,
"K",0,15,12, 5,    "D",0,15,12, 6,  "G",0,15,12, 7, "m",0,15,12, 8, "O",0,15,12, 9,
"N",0,15,12,10,    "H",0,15,12,11,  "ffi",0,17,12,12, "ffl",0,17,12,13, "\220",1,15,12,14,
"\324",1,15,12,15, "oe!",2,15,12,16,
...
"+",0,18,14, 0, "+",1,18,14, 1, "\222",1,18,14, 2, "M",1,18,14, 3, "%",0,18,14, 4,
"OE!",1,18,14, 5, "3/4",1,18,14, 6, "W",0,18,14, 7, "W",1,18,14, 8, "OE!",0,18,14, 9,
"=",0,18,14,10, "\222",0,18,14,11, "1/2",0,18,14,12, "1/4",0,18,14,13, "&",1,18,14,14,

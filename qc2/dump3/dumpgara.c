...
6
   ...
   hexdump : #include < c:\qc2\dump3\dumpin01.c >
   control : #include < c:\qc2\dump3\intfdump.c >
...
/* #include <c:\qc2\dump3\incxdump.c> */
...
void aline_caster();
void spaces();
void cases2();       /* in: c:\qc2\dump\dumpin01.c     */
...
#include <c:\qc2\dump3\inc0dump.c>
...
#include <c:\qc2\dump3\intfdump.c>

/* #include <c:\qc2\dump\ontcijf3.c>*/
...
#include <c:\qc2\dump3\dumpin01.c>
...
#include <c:\qc2\dump3\get__rtn.c>
...
main()
{
	...
	*/
       ...
       switch ( c ) {
	  case 'Y' : stoppen = 0; break;
	  case 'J' : stoppen = 0; break;
	  case 'y' : stoppen = 0; break;
	  case 'j' : stoppen = 0; break;

	  case 'N' : stoppen = 1; break;
	  case 'n' : stoppen = 1; break;
	  default  : stoppen = 1; break;
       }

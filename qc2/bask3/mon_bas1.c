/* mon_gar1.c gegevens caslon 12 punt
	       wig
...
void show()
{
    ...
    for (ri=0, ki=145; ri< 20 ; ri++) {
	printf(" ri %3d ki %3d naam %3d  voor %3d na %3d ",
	      ri, ki,
...
void show2()
{
    ...
    do {
       printf(" r_t1 %3d voor %3d na %3d ",voorraad[r_t1].name,
	     voorraad[r_t1].fname, voorraad[r_t1].lname);
       if (getchar()=='#') exit(1);
...
struct gegevens central5 = { 48,   272, NORM2,    0, 'd',
			    12.0,
			    /* 30.,  24.,   */ 24.,
			    /*5.328, 4.2624,*/ 4.26,
			    /* 552,  442,   */ 460,
...
unsigned char wig[RIJAANTAL] = {
	  ...
	  5,6,7,8,9, 9,10,10,11,11, 13,14,15,16,18,18 /* = 334 wig */
...
int matmax = 322; /* maximum number of matrices in the array

...
void intro1(void)
{
     cls();
     printf("\n\n");
     print_at(3,30,"   MONOTYPE Coding Program");
     print_at(4,30,"       version 1.0.0");
     print_at(6,30,"       11 feb. 2004");
     print_at(8,30,"      John Cornelisse");
...
void intro(void)
{
     ...
     print_at(4,30,"    MONOTYPE Coding Program");

     print_at(6,30,"        version 1.0.0");
     print_at(7,30,"       8 september 2004");
     /*

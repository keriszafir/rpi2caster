...
void aline_caster()
{
    ...
    /* mcx[0] = 0x48; */
    /* nk */
    mcx[1] = PUMPON; /* 0x24;  0075 = pump on */
    mcx[2] = 0x10;   /* position 3 */
    ...
    do
    {
       ...
       mcx[1] = PUMPON;
       mcx[2] = 0x0;
       mcx[3] = PUMPOFF; /* 0x81; 0005 => 8 position */

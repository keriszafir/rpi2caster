...
#include <c:\qc2\transl2\moncas10.c>

     /* central : wig = 602 wedge
	matmax  = 400
...
#include <c:\qc2\transl2\caslon10.c>

/* naar caslon10 verwijzen */

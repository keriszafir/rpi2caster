/*
  ...
  info wedge  in file :   c:\qc2\stripc\monobai1.C  inc1
  info matrix in file :  <c:\qc2\stripc\monobai6.c> inc6

  info afbreken in                      monoin10.c  inc9
  marge en lus  in                      moninc10.c
...
#include <c:\qc2\last\monobai1.c>

/* #include <c:\qc2\stripc\monobai1.c> */
...
#include <c:\qc2\last\monobai6.c>
#include <c:\qc2\last\monoinc7.c>
#include <c:\qc2\last\monoinc8.c>
#include <c:\qc2\last\moninc10.c>
/*
#include <c:\qc2\stripc\monobai6.c>
#include <c:\qc2\stripc\monoinc7.c>
#include <c:\qc2\stripc\monoinc8.c>
#include <c:\qc2\stripc\moninc10.c>
 */
...
void test_codes()
{
   ...
   do
   {
	 ...
	 do {
	    ...
	    while (t_d < -9 || t_d > 24 );
	 printf("t %1c %1c %1c %1d",tsb[0], tsb[1], tsb[2] ,test_kl);
	 getchar();

	 test_u  = zoek( tsb , test_kl , 255 ) ;
	 printf("T_u %3d",test_u);
	 if (getchar() == '#') exit(1);
...
void leesregel()
{
   ...
   for (crp_i=0;  crp_i<HALFBUFF-3 &&
	   ...
	   if ( crp_l == '@' ) {  /*detection end of line */
...
#include <c:\qc2\last\monoin00.c>

/*
#include <c:\qc2\stripc\monoin00.c>
 */
...
main()
{
    ...
    printf("Monotype program baskerville \n\n\n");
    printf("version 18 dec 2004 ");
    getchar();
    /*

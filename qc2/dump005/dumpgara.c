/*
   ...
   hexdump : #include < c:\qc2\dump005\dumpin01.c >
   control : #include < c:\qc2\dump005\intfdump.c >
...
int getlineAO();     /* c:\qc2\dump005\getline.c */
int getline10();     /* c:\qc2\dump005\getline.c */
int get_line();      /* c:\qc2\dump005\getline.c */

int get__line(int row, int col);   /* c:\qc2\dump005\get__rtn.c */
double get__float(int row, int col);  /* c:\qc2\dump005\get__rtn.c */
int get__dikte(int row, int col);  /* c:\qc2\dump005\get__rtn.c */
int get__int(int row, int col);    /* c:\qc2\dump005\get__rtn.c */
int get__row(int row, int col);    /* c:\qc2\dump005\get__rtn.c */
int get__col(int row, int col);    /* c:\qc2\dump005\get__rtn.c */
...
void thin_spaces();    /* c:\qc2\dump005\dumpin01.c */
void test();           /* c:\qc2\dump005\dumpin01.c */
void test2();          /* c:\qc2\dump005\dumpin01.c */
void set_bb( char c);
void cases2();         /* c:\qc2\dump005\dumpin01.c */
int  case_j;
void f3( int ccc );    /* c:\qc2\dump005\dumpin01.c */
void f1();             /* c:\qc2\dump005\dumpin01.c */
void f2();             /* c:\qc2\dump005\dumpin01.c */
void kies_syst();      /* c:\qc2\dump005\dumpin01.c */
void seekmain();
void hexdump();        /* c:\qc2\dump005\dumpin01.c */

/* functions in  :     <c:\qc2\dump005\inc0dump.c>
...
void intro();          /* c:\qc2\dump005\inc0dump.c */
void aline_caster();   /* c:\qc2\dump005\inc0dump.c */
void test_caster();    /* c:\qc2\dump005\inc0dump.c */

void setbit(int nr);   /* c:\qc2\dump005\inc0dump.c */
void setrow(int row);  /* c:\qc2\dump005\inc0dump.c */
void set_row( unsigned char s[4], int row );
		       /* c:\qc2\dump005\inc0dump.c */
void setcol(int col);  /* c:\qc2\dump005\inc0dump.c */


int read_row( );         /* c:\qc2\dump005\inc0dump.c */
int read_col( );         /* c:\qc2\dump005\inc0dump.c */
void set_x_col(unsigned char s[4], int col);
			 /* c:\qc2\dump005\inc0dump.c */
...
/* functions in <c:\qc2\dump005\incxdump> : */

int    p_atoi( int n );   /* c:\qc2\dump005\incxdump */
double p_atof( int n );   /* c:\qc2\dump005\incxdump */
void   print_at( unsigned int r, unsigned int c, char x[] );
			  /* c:\qc2\dump005\incxdump */
void spaces();            /* c:\qc2\dump005\incxdump */
void apart();             /* c:\qc2\dump005\incxdump */
void apart2();            /* c:\qc2\dump005\incxdump */
void apart3();            /* c:\qc2\dump005\incxdump */
int read_width(int wig);  /*empty function */

/* einde include */

void cijfer();            /* c:\qc2\dump005\intfdump.c */
void cls();               /* c:\qc2\dump005\intfdump.c */
void ontcijfer();         /* c:\qc2\dump005\intfdump.c */
void ontcijfer2();        /* c:\qc2\dump005\intfdump.c */
void disp_bytes();        /* c:\qc2\dump005\intfdump.c */
void delay2( int tijd );  /* c:\qc2\dump005\intfdump.c */
void di_spcode();         /* c:\qc2\dump005\intfdump.c */
void dispmono();          /* c:\qc2\dump005\intfdump.c */
void control();           /* c:\qc2\dump005\intfdump.c */
int test_row();           /* c:\qc2\dump005\intfdump.c */
int test_NK();            /* c:\qc2\dump005\intfdump.c */
int test_NJ();            /* c:\qc2\dump005\intfdump.c */
int test2_NK(); /* uses mcx[] */
			  /* c:\qc2\dump005\intfdump.c */
int test2_NJ();           /* c:\qc2\dump005\intfdump.c */
int test_O15();           /* c:\qc2\dump005\intfdump.c */
int test_N();             /* c:\qc2\dump005\intfdump.c */
int test_k();             /* c:\qc2\dump005\intfdump.c */
int test_g();             /* c:\qc2\dump005\intfdump.c */
int test_GS();            /* c:\qc2\dump005\intfdump.c */
void zoekpoort();         /* c:\qc2\dump005\intfdump.c */
void init();              /* c:\qc2\dump005\intfdump.c */
void init_aan();          /* c:\qc2\dump005\intfdump.c */
void init_uit();          /* c:\qc2\dump005\intfdump.c */
void busy_uit();          /* c:\qc2\dump005\intfdump.c */
void busy_aan();          /* c:\qc2\dump005\intfdump.c */
void strobe_on ();        /* c:\qc2\dump005\intfdump.c */
void strobe_out();        /* c:\qc2\dump005\intfdump.c */
void strobes_out();       /* c:\qc2\dump005\intfdump.c */
void gotoXY(int r,int k); /* c:\qc2\dump005\intfdump.c */
int  nood;
void noodstop();          /* c:\qc2\dump005\intfdump.c */
void startinterface();    /* c:\qc2\dump005\intfdump.c */
void zenden_codes();      /* c:\qc2\dump005\intfdump.c */
...
#include <c:\qc2\dump005\incxdump.c>
...
#include <c:\qc2\dump005\wedges.c>
...
#include <c:\qc2\dump005\dumpin01.c>

/* #include <c:\qc2\dump005\dumpin02.c>

   corrigeren voor een wig met 15 units in rij 15...

*/

#include <c:\qc2\dump005\inc0dump.c>
...
#include <c:\qc2\dump005\intfdump.c>
#include <c:\qc2\dump005\getline.c>
#include <c:\qc2\dump005\get__rtn.c>

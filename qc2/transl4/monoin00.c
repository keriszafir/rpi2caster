		 ...
		 case 0 :
		    switch (key ) {
			  ...
			  switch (readbuffer[ t3j ]) {
				...
				cop[ncop++] = 0;
				cop[ncop++] = 0x10; /* E */
				cop[ncop++] = 0x20; /* 2   3 => 0x10 */
				cop[ncop++] = 0;
				line_data.wsum +=  /* e3 -> wig[2] */
		    ...
		    switch (key ){
			  ...
			  goed = 1;
			   /* add a '-'0                   0
				...
				onml kjih  gfSe d7cb a1234567 89abcde0
			    e3                5                   5
				   0,     0x10 ,    0x10, 0

			    calculate adjustment
			    routine fill line:  marge( )

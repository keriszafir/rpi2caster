/*
  ...
  info testzoek5 in file : c:\qc2\bask\monoin00.c
	      ...
	      #include <c:\qc2\stripc\moti11it.c> = matrijzenraam 11 times

	      monoba14.c> * gegevens matrijzenmcraam *
...
#include <c:\qc2\bask\mon_ti11.c> /* : wig [] 536... */

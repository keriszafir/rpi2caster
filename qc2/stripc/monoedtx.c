/*
  ...
  info wedge  in file :   c:\qc2\stripc\monoinc5.C
  info linewidth      :
...
struct   monocode  coderec;     / * file record code file * /
  ...
  */
    printf(" zetbreedte %8.2f aug",central.rwidth );
    printf(" %8.4f inch = ",central.inchwidth );
    printf(" %5d units   %5d stop = # ", central.lwidth);
    if (getchar()=='#') exit(1);

/* monoinb1.c gegevens bembo 13 punt */
 ...
 */
struct gegevens central = { 41,     /* set 51        47*/
			    255,    /* mats  15*17 = 255, 272 = 16*17  */
			    NORM2,
			    0,      /* nu unit adding  */
			    'd',    /* didot          */
			    12.0,   /* corps        */
   /* 20.,   16 width     */  23.,    /*   28.,      30.,    25.,    24.,    */
   /* 3.552, 2.8416 inch width*/   4.0848,/*  4.9728,   5.328,  4.44,     4.2624,*/
   /*449.,  359.  units   */ 516.,    /* 629.,    674.,   561.,     539.,    */
			    'n',
			    'r',
			    'n' } ;

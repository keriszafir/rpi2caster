/* monoinc1.c gegevens cochin 12: 12.25 set gegoten op 12.5 set */
...
/*    135-12 = 11 punt bodoni
       23 cicero = 4.0848" = 451 units 11 3/4 set (47)
       24 cicero = 4.2624" = 470 units 11 3/4 set

      135-13 = 12 punt bodoni'
       23 cicero = 4.0848" = 415 units 12 34 set (51)
       24 cicero = 4.2624" = 433 units 12.75 set


 */
struct gegevens central = { 50,     /* set          51        47*/
			    255,    /* mats  15*17 = 255, 272 = 16*17  */
			    NORM2,
			    0,      /* nu unit adding  */
			    'd',    /* didot          */
			    12.0,   /* corps        */
   ...
   /*368.,   units     424.,    515.,     552.,   469.,   */  442.,
			    'n',
			    'r',
			    'n' } ;

struct gegevens central5 = { 50,   272, NORM2,    0, 'd',
			    12.0,
			    /* 30.,  24.,   */ 28.,
			    /*5.328, 4.2624,*/ 4.9728,
			    /* 552,  442,   */ 516,
...
char sg [] =
       ...
       71,70,83,69,  68,103,67,66,
       65,45,49,50,  51,52,53,54,
       55,56,57,97,  98,99,100,101,
       102,107
    };
...
void di_spcode()
{
    ...
    if (mcx[0] & 0x80 ) prr(0); /* O */
    if (mcx[0] & 0x40 ) prr(1); /* N */
    if (mcx[0] & 0x20 ) prr(2); /* M */
    if (mcx[0] & 0x10 ) prr(3); /* L */
    if (mcx[0] & 0x08 ) prr(4); /* K */
    if (mcx[0] & 0x04 ) prr(5); /* J */
    if (mcx[0] & 0x02 ) prr(6); /* I */
    if (mcx[0] & 0x01 ) prr(7); /* H */
    if (mcx[1] & 0x80 ) prr(8); /* G */
    if (mcx[1] & 0x40 ) prr(9); /* F */
    if (mcx[1] & 0x20 ) prr(10);/* s */
    if (mcx[1] & 0x10 ) prr(11);/* E */
    if (mcx[1] & 0x08 ) prr(12);/* D */
    if (mcx[1] & 0x04 ) prr(13);/* g */
    if (mcx[1] & 0x02 ) prr(14);/* C */
    if (mcx[1] & 0x01 ) prr(15);/* B */
    if (mcx[2] & 0x80 ) prr(16);/* A */
		       prr(17); /* - */
    if (mcx[2] & 0x40 ) prr(18);/* 1 */
    if (mcx[2] & 0x20 ) prr(19);/* 2 */
    if (mcx[2] & 0x10 ) prr(20);/* 3 */
    if (mcx[2] & 0x08 ) prr(21);/* 4 */
    if (mcx[2] & 0x04 ) prr(22);/* 5 */
    if (mcx[2] & 0x02 ) prr(23);/* 6 */
    if (mcx[2] & 0x01 ) prr(24);/* 7 */
    if (mcx[3] & 0x80 ) prr(25);/* 8 */
    if (mcx[3] & 0x40 ) prr(26);/* 9 */
    if (mcx[3] & 0x20 ) prr(27);/* a */
    if (mcx[3] & 0x10 ) prr(28);/* b */
    if (mcx[3] & 0x08 ) prr(29);/* c */
    if (mcx[3] & 0x04 ) prr(30);/* d */
    if (mcx[3] & 0x02 ) prr(31);/*4");*/
    if (mcx[3] & 0x01 ) prr(32);/*(); */
    printf("               ");

...
#include <c:\qc2\stripc\monogar1.c>
...
#include <c:\qc2\stripc\monogar6.c> /* gegevens matrijzenraam */
...
void afbreken( void )
{
	...
	*/
	   ...
	   ncop  = pcop[nschuif-1];
	      /* dit is gevaarlijk, want het gooit een helebpel data weg

		 beter: tijdelijk bewaren rest van cop, in een 'rest'-buffer
		 de regel uitvullen
		 de gemaakte code
	  ...
	  case 79 : /* in a word */
		 ...
		 case '_' :
		    ...
		    /*
		       ...
		       invoegen code
		       vullen readbuffer3
		       wegschrijven readbuffer3 in 'tx1' -file
		 ...
		 default  :
		    ...
		    readbuffer3[endstr   ]='-';
		    readbuffer3[endstr+1 ]='^';
		    readbuffer3[endstr+2 ]='C';
		    readbuffer3[endstr+3 ]='R';
		    readbuffer3[endstr+4 ]='\015';
		    readbuffer3[endstr+5 ]='\012';
		    readbuffer3[endstr+6 ]='\0';

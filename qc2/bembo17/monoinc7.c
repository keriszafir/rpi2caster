...
void intro1(void)
{
     ...
     print_at(4,34," version 1.2.1");
     print_at(6,34,"   2 june 2005");
...
void intro(void)
{
	...
	ntr_lw = read_real( );
     ...
     switch ( ntrcx) {
	case 'p':
	   central.inchwidth = ntr_lw * .1667;
	   break;
	case 'd':
	   central.inchwidth = ntr_lw * .1776;
	   break;
	case 'f':    /* 12 points fournier = 11 points didot */
	   central.inchwidth = ntr_lw * .1628;
	   break;
     }
     ...
     ntr_lwidth = ntr_lw;
     do {
	print_at(10,25,"    set character (5.-16.) = ");
	ntr_rset = read_real ( );
	...
	ntr_rset = ( float ) ( ntrset * .25);     /* rounding at .25 */
     ...
     central.lwidth = (int) ( .5 + (central.inchwidth * 5184. / central.cset)  );
	...
	ntr_rset = ( float ) ( ntrset * .25);     /* rounding at .25 */
     ...
     ntrl = (int) (( (central.inchwidth * 5184.) / central.wset ) +.5) ;


     print_at(9,3," ");
     switch (ntrcx) {
	case 'd' :
	   printf("line width =%8.5f inch = %4.1f cic = %5d units %6.2f set \n",
		   central.inchwidth,
		   central.rwidth,
		   central.lwidth,
		   ((float) central.cset) *.25
		   );
	   printf("wedge: %4d units %6.2f set ",
		   ntrl,
		   ((float) central.wset) *.25 );
	   break;
	case 'p' :
	   printf("line width =%8.5f inch = %4.1f pica = %5d units %6.2f set \n",
		   central.inchwidth,
		   central.rwidth,
		   central.lwidth,
		   central.cset
	   ...
	   break;
	case 'f' :
	   printf("line width =%8.5f inch = %4.1f four = %5d units %6.2f set \n",
		   central.inchwidth,
		   central.rwidth,
		   central.lwidth,
		   central.cset
...
void pri_cent(void)
{
    ...
    print_at(4,10,"set character      =");
    printf("%6.2f ", (float) central.cset);
    print_at(4,10,"set wedge          =");
    printf("%6.2f ", (float) central.wset);

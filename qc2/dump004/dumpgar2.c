/*
   ...
   last version mai 2010 :

   KS2 = variable space for Large composition
   ...
   hexdump : #include < c:\qc2\dump004\dumpin01.c >
   control : #include < c:\qc2\dump004\intfdump.c >
...
int getlineAO();     /* c:\qc2\dump004\getline.c */
int getline10();     /* c:\qc2\dump004\getline.c */
int get_line();      /* c:\qc2\dump004\getline.c */

int get__line(int row, int col);   /* c:\qc2\dump004\get__rtn.c */
double get__float(int row, int col);  /* c:\qc2\dump004\get__rtn.c */
int get__dikte(int row, int col);  /* c:\qc2\dump004\get__rtn.c */
int get__int(int row, int col);    /* c:\qc2\dump004\get__rtn.c */
int get__row(int row, int col);    /* c:\qc2\dump004\get__rtn.c */
int get__col(int row, int col);    /* c:\qc2\dump004\get__rtn.c */
...
void thin_spaces();    /* c:\qc2\dump004\dumpin01.c */
void test();           /* c:\qc2\dump004\dumpin01.c */
void test2();          /* c:\qc2\dump004\dumpin01.c */
void set_bb( char c);
void cases2();         /* c:\qc2\dump004\dumpin01.c */
int  case_j;
void f3( int ccc );    /* c:\qc2\dump004\dumpin01.c */
void f1();             /* c:\qc2\dump004\dumpin01.c */
void f2();             /* c:\qc2\dump004\dumpin01.c */
void kies_syst();      /* c:\qc2\dump004\dumpin01.c */
void seekmain();
void hexdump();        /* c:\qc2\dump004\dumpin01.c */

/* functions in  :     <c:\qc2\dump004\inc0dump.c>
...
void intro();          /* c:\qc2\dump004\inc0dump.c */
void aline_caster();   /* c:\qc2\dump004\inc0dump.c */
void test_caster();    /* c:\qc2\dump004\inc0dump.c */

void setbit(int nr);   /* c:\qc2\dump004\inc0dump.c */
void setrow(int row);  /* c:\qc2\dump004\inc0dump.c */
void set_row( unsigned char s[4], int row );
		       /* c:\qc2\dump004\inc0dump.c */
void setcol(int col);  /* c:\qc2\dump004\inc0dump.c */


int read_row( );         /* c:\qc2\dump004\inc0dump.c */
int read_col( );         /* c:\qc2\dump004\inc0dump.c */
void set_x_col(unsigned char s[4], int col);
			 /* c:\qc2\dump004\inc0dump.c */
...
/* functions in <c:\qc2\dump004\incxdump> : */

int    p_atoi( int n );   /* c:\qc2\dump004\incxdump */
double p_atof( int n );   /* c:\qc2\dump004\incxdump */
void   print_at( unsigned int r, unsigned int c, char x[] );
			  /* c:\qc2\dump004\incxdump */
void spaces();            /* c:\qc2\dump004\incxdump */
void apart();             /* c:\qc2\dump004\incxdump */
void apart2();            /* c:\qc2\dump004\incxdump */
void apart3();            /* c:\qc2\dump004\incxdump */
int read_width(int wig);  /*empty function */

/* einde include */

void cijfer();            /* c:\qc2\dump004\intfdump.c */
void cls();               /* c:\qc2\dump004\intfdump.c */
void ontcijfer();         /* c:\qc2\dump004\intfdump.c */
void ontcijfer2();        /* c:\qc2\dump004\intfdump.c */
void disp_bytes();        /* c:\qc2\dump004\intfdump.c */
void delay2( int tijd );  /* c:\qc2\dump004\intfdump.c */
void di_spcode();         /* c:\qc2\dump004\intfdump.c */
void dispmono();          /* c:\qc2\dump004\intfdump.c */
void control();           /* c:\qc2\dump004\intfdump.c */
int test_row();           /* c:\qc2\dump004\intfdump.c */
int test_NK();            /* c:\qc2\dump004\intfdump.c */
int test_NJ();            /* c:\qc2\dump004\intfdump.c */
int test2_NK(); /* uses mcx[] */
			  /* c:\qc2\dump004\intfdump.c */
int test2_NJ();           /* c:\qc2\dump004\intfdump.c */
int test_O15();           /* c:\qc2\dump004\intfdump.c */
int test_N();             /* c:\qc2\dump004\intfdump.c */
int test_k();             /* c:\qc2\dump004\intfdump.c */
int test_g();             /* c:\qc2\dump004\intfdump.c */
int test_GS();            /* c:\qc2\dump004\intfdump.c */
void zoekpoort();         /* c:\qc2\dump004\intfdump.c */
void init();              /* c:\qc2\dump004\intfdump.c */
void init_aan();          /* c:\qc2\dump004\intfdump.c */
void init_uit();          /* c:\qc2\dump004\intfdump.c */
void busy_uit();          /* c:\qc2\dump004\intfdump.c */
void busy_aan();          /* c:\qc2\dump004\intfdump.c */
void strobe_on ();        /* c:\qc2\dump004\intfdump.c */
void strobe_out();        /* c:\qc2\dump004\intfdump.c */
void strobes_out();       /* c:\qc2\dump004\intfdump.c */
void gotoXY(int r,int k); /* c:\qc2\dump004\intfdump.c */
int  nood;
void noodstop();          /* c:\qc2\dump004\intfdump.c */
void startinterface();    /* c:\qc2\dump004\intfdump.c */
void zenden_codes();      /* c:\qc2\dump004\intfdump.c */
...
#include <c:\qc2\dump004\incxdump.c>
...
/*
int wedge___5[16] = {5,6,7,8,9,  9, 9,10,10,11, 12,13,14,15,18, 18};
int wedge_111[16] = {5,6,7,8,8,  8, 9, 9, 9, 9, 10,12,12,13,15, 15};
int wedge_344[16] = {5,6,7,9,9,  9,10,11,11,12, 12,13,14,15,16, 16};
int wedge_377[16] = {5,6,7,8,8,  9, 9,10,10,11, 12,13,14,15,18, 18};
int wedge_409[16] = {5,6,7,8,8,  9, 9,10,10,11, 12,13,14,15,16, 16};
int wedge_467[16] = {5,6,7,8,8,  9, 9, 9,10,11, 12,13,14,15,18, 18};
int wedge_486[16] = {5,7,6,8,9, 11,10,10,13,12, 14,15,15,18,16, 16};

int wedge_562[16] = {5,6,7,8,9,  9, 9,10,11,12, 13,14,15,17,18, 18};
int wedge_607[16] = {5,6,7,8,9,  9, 9, 9,10,11, 12,13,14,15,18, 18};
int wedge1329[16] = {4,5,7,8,9,  9, 9, 9,10,10, 11,12,12,13,15, 15};
int wedge1331[16] = {4,5,7,8,8,  9, 9, 9, 9,10, 11,12,12,13,15, 15};
int wedge1406[16] = {4,5,6,7,8,  8, 9, 9, 9, 9, 10,10,11,12,13, 15};
int wedgetpwr[16] = {9,9,9,9,9,  9, 9, 9, 9, 9,  9, 9, 9, 9, 9,  9};

*/

int wedge__96[16] = {5,6,7,8,9,  9,10,10,11,12, 13,14,15,16,18, 18};
int wedge_334[16] = {5,6,7,8,9,  9,10,10,11,11, 13,14,15,16,18, 18};
int wedge_536[16] = {5,6,7,8,9,  9,10,10,11,12, 13,14,15,17,18, 18};
int wedge_611[16] = {6,6,7,9,9, 10,11,11,12,12, 13,14,15,16,18, 18};
int wedge_674[16] = {5,6,7,8,8,  9, 9, 9,10,10, 11,12,13,14,15, 18};
int wedge_724[16] = {5,6,7,8,8,  9, 9,10,10,11, 13,14,15,16,18, 18};
int wedge_990[16] = {5,5,6,7,8,  9, 9, 9, 9,10, 10,11,13,14,18, 18};
int wedge1063[16] = {5,6,8,9,9,  9, 9,10,12,12, 13,14,15,15,18, 18};
...
void choose_wedge()
{
    ...
    unsigned char keuze;
      ...
      cls();
      do {
	print_at( 1,35,          "Choose a wedge ");
	print_at( 3,10,"  ");printf("Standaard   wedge S5    =  1    Standaard 2 wedge S96   = 2");
	print_at( 4,10,"  ");printf("Grieks      wedge S111  =  3                wedge S211  =  ");
	print_at( 5,10,"  ");printf("Bembo       wedge S334  =  5    Grotesque   wedge S344  = 6");
	print_at( 6,10,"  ");printf("Baskerville wedge S377  =  7    Bembo       wedge S409  = 8");
	print_at( 7,10,"  ");printf("Baskerville wedge S467  =  9    Bembo       wedge S486  = 0");
	print_at( 8,10,"  ");printf("Typewriter  wedge S535  =  a    Garamond    wedge S536  = b");
	print_at( 9,10,"  ");printf("            wedge S562  =  c                wedge S607  = d");
	print_at(10,10,"  ");printf("            wedge S611  =  e    series 215  wedge S674  = f");
	print_at(11,10,"  ");printf("Bembo       wedge S724  =  g                wedge S830  =  ");
	print_at(12,10,"  ");printf("            wedge S872  =                   wedge S990  = j");
	print_at(13,10,"  ");printf("            wedge S1063 =  k    Univers     wedge S1329 = l");
	print_at(14,10,"  ");printf("Univers     wedge S1331 =  m    Univers     wedge S1406 = n");
	print_at(18,25,"                                      ");
	print_at(18,25,"            keuze = ");
	keuze = getchar();
	 /* if (keuze == '#') exit(1); */
      } while (
	    keuze != '1' && keuze != '2'
	 ...
	 && keuze != 'm' && keuze != 'n'
      ...
      switch (keuze) {
	case '1': pw= &wedge___5[0]; break;
	case '2': pw= &wedge__96[0]; break;
	case '3': pw= &wedge_111[0]; break;
	/* case '4': pw= &wedge_211[0]; break;*/
	case '5': pw= &wedge_334[0]; break;
	case '6': pw= &wedge_344[0]; break;
	case '7': pw= &wedge_377[0]; break;
	case '8': pw= &wedge_409[0]; break;
	case '9': pw= &wedge_467[0]; break;
	case '0': pw= &wedge_486[0]; break;
	case 'a': pw= &wedgetpwr[0]; break;
	case 'b': pw= &wedge_536[0]; break;
	case 'c': pw= &wedge_562[0]; break;
	case 'd': pw= &wedge_607[0]; break;
	case 'e': pw= &wedge_611[0]; break;
	case 'f': pw= &wedge_674[0]; break;
	case 'g': pw= &wedge_724[0]; break;
	/* case 'h': pw= &wedge_830[0]; break; */
	/* case 'i': pw= &wedge_872[0]; break; */
	case 'j': pw= &wedge_990[0]; break;
	case 'k': pw= &wedge1063[0]; break;
	case 'l': pw= &wedge1329[0]; break;
	case 'm': pw= &wedge1331[0]; break;
	case 'n': pw= &wedge1406[0]; break;
      };
      for (i=0;i<=15;i++) wedge[i] = *(pw+i);
      do {
	print_at(20,2,"row  : ");
	for (i=0;i<=15;i++) {
	    printf(" %2d",i+1);
	...
	print_at(22,30,"continue = j / y ");
	keuze = getchar();

	if (keuze =='#') exit(1);
      }
	while (keuze != 'y' && keuze != 'j');

}


#include <c:\qc2\dump004\wedges.c>
...
char menu()
{
	...
	print_at(11,15,"               spaces      = s ");
	print_at(12,15,"               cases       = c ");
	print_at(13,15,"            thin spaces    = T ");
	print_at(14,15,"         casting files     = f ");
	print_at(15,15,"         casting ornaments = o ");
	print_at(17,15,"           tests interface : ");

	print_at(19,15,"         caster            = C ");
	print_at(20,15,"         valves            = v ");
	print_at(21,15,"         rows & columns    = t ");

	print_at(22,15,"              end program  = #");
	print_at(24,15,"               command =");
	while ( ! kbhit());
...
#include <c:\qc2\dump004\dumpin01.c>

/* #include <c:\qc2\dump004\dumpin02.c>

   corrigeren voor een wig met 15 units in rij 15...

*/

#include <c:\qc2\dump004\inc0dump.c>
...
#include <c:\qc2\dump004\intfdump.c>
#include <c:\qc2\dump004\getline.c>
#include <c:\qc2\dump004\get__rtn.c>
...
main()
{
    ...
    /*
	 test();   test interface  c:\qc2\dump_003\inc0dump.c
	 aline_caster();

...
void choose_wedge()
{
    ...
    do {
      ...
      print_at( 3,5,"Standaard   wedge S5    =  1  Standaard 2 wedge S96   = 2");
      print_at( 4,5,"90/91/106   wedge S111  =     Grieks      wedge S211  = 4");
      print_at( 5,5,"Bembo       wedge S334  =  5  Grotesque   wedge S344  = 6");
      print_at( 6,5,"Baskerville wedge S377  =  7  Bembo       wedge S409  = 8");
      print_at( 7,5,"Baskerville wedge S467  =  9  Bembo       wedge S486  = 0");
      print_at( 8,5,"Typewriter  wedge S535  =  a  Garamond    wedge S536  = b");
      print_at( 9,5,"            wedge S562  =  c              wedge S607  = d");
      print_at(10,5,"            wedge S611  =  e  series 215  wedge S674  = f");
      print_at(11,5,"Bembo       wedge S724  =  g              wedge S830  =  ");
      print_at(12,5,"            wedge S872  =                 wedge S990  = j");
      print_at(13,5,"Univers     wedge S1063 =  k              wedge S1329 = l");
      print_at(14,5,"            wedge S1331 =  m  Univers     wedge S1406 = n");
   ...
   /* case '4': pw= &wedge_211[0]; break;*/
      ...
      case 'a': pw= &wedge_536[0]; break;
      case 'b': pw= &wedgetpwr[0]; break;
   ...
   /* case 'i': pw= &wedge_872[0]; break; */
    ...
    do {
      ...
      for (i=0;i<=15;i++) printf(" %2d",i+1);
      print_at(23,2,"units: ");
      for (i=0;i<=15;i++) printf(" %2d",wedge[i]);

      print_at(24,45,"continue = j / y ");
      keuze = getchar();
      if (keuze =='#') exit(1);
    }

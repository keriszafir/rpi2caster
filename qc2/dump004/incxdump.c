...
int wedge[16]     = {5,6,7,8,9,  9, 9,10,10,11, 12,13,14,15,18, 18}; /* = 5 wedge */
...
int wedge_526[16] = {5,6,7,8,9,  9,10,10,11,12, 13,14,15,17,18, 18};
...
int p_atoi(int n )
{
    ...
    /*
    printf("first pr =%3d sign = %2d res = %8d ",pr,teken, pr*teken); getchar();
    if(getchar()=='#') exit(1);
     */
...
void spaces()
{
    ...
    pump_on[0] = 0x00; pump_on[1]=0x24;
    pump_on[2]=0; pump_on[3]=0;
    ...
    do {
	  ...
	  printf("ready with this spaces <y/n> ");
	  _cont = getchar();

	  switch ( _cont ){
	     case 'y' : _cont= 'y'; break;
	     case 'Y' : _cont= 'y'; break;
	     case 'J' : _cont= 'y'; break;
	     case 'j' : _cont= 'y'; break;
	     case '#' : exit(1); break;
	     default  : _cont = 'n'; break;
	  }
       }
	  while ( _cont != 'y' );


       printf("end routine = e "); while ( ! kbhit() );
       _cont = getch();
...
void apart3()
{
    ...
    do
    {
     ...
     for (tj=0;tj<4;tj++) mcx[tj]=0;
      ...
      mcx[3] = 0x81; /* pump off */
      f1();
      if ( interf_aan ) zenden_codes(); /* line out */
      mcx[1] = 0x20;  /* S */

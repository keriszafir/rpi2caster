/*
  ...
  info testzoek5 in file : c:\qc2\ehrhart\monoin00.c


	      #include <c:\qc2\stripc\monogar1.c> : wig [] 536...
	      #include <c:\qc2\stripc\monoti11
	      ba14.c> * gegevens matrijzenmcraam *
				      monoga12 = 12 punt 156-12
				      monoga10 = 10 punt 156-11

  info wedge  in file :   c:\qc2\ehrhart\mon_gar1.C  inc1
       central
		  c:\qc2\caslon\monocas1.c

  info matrix 12 point garamond in file garamond :

		  c:\qc2\ehrhart\monoehrh.c
...
#include <c:\qc2\ehrhart\mon_bas1.c> /* : wig [] 536... */
...
#include <c:\qc2\ehrhart\monoti11.c>
...
#include <c:\qc2\ehrhart\monoinc7.c>  /* intro intro1 */
#include <c:\qc2\ehrhart\monoinc8.c>
#include <c:\qc2\ehrhart\moninc10.c>
#include <c:\qc2\ehrhart\monolus.c>
...
#include <c:\qc2\ehrhart\monoin00.c>

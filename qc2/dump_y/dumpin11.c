...
void hexdump()
{
    ...
    */
    ...
    w05 = 8;
    if ( width_row15 != 18){
	corr = ( 18 - width_row15) * file_set * 1.5432099 ;
	corr += .5;

	/* printf("Corr %8.5f \n",corr); */

	icorr = ( (int) corr ) + 53;
	if (icorr < 16 ) icorr = 16;
	...
	/*  if the wedge not correctly placed
	    printf("calculated: w75 = %4d w05 = %4d ",w75,w05);
	    if (getchar()=='#') exit(1);
	 */
    }
	...
	if ( ! test_NJ() ) {
		 ...
		 */
		  ...
		  zenden_codes();
	       ...
	       if ( test_O15() ) {  /* a square is cast */
		  if ( width_row15 != 18 ) { /* calculate correction */
		      /*
		      corr = ( 18 - width_row15) * file_set * 1.5432099 ;
		      corr += .5;
		      icorr = ( (int) corr ) + 53;
			 ...
			 icorr -= 15;
		      ...
		      mcx[0]=0x0;
		      mcx[1]=0x20;/* activate S-needle */
		      mcx[2]=0x0;
		      mcx[3]=0x0;
		  }
	       }

	       /* sent code to interface */
...
void cases2()
{
    ...
    int i,j, number,b, iinch,dx, ww;
    int ready, ready_with_this_char, iw;
    ...
    if (iw==1) {
       ...
       print_at(10,9,"Casting for cases based on the 5-wedge ");
    };
    if (iw == 2 ){
       ...
       print_at(10,9,"Casting for cases based on the S536-wedge ");
    };
    if (iw == 3){
       ...
       print_at(10,9,"Casting for cases based on the 211-wedge ");
    };
    if (iw == 4) {
       ...
       wedge[ 8]= 10;wedge[ 9]= 11;wedge[10]= 12;wedge[11]= 13;
       wedge[12]= 14;wedge[13]= 15;wedge[14]= 18;wedge[15]= 18;
       print_at(10,9,"Casting for cases based on the 377-wedge \n\n");

    };
    /* printf("Uit de lus "); if (getchar()=='#') exit(1);*/

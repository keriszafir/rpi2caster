...
void cases2()
{
    ...
    cls();
    do {
       print_at(8,1,"Chose wedge to be used:");
       print_at(8,3,"Standard wedge: S5   = 1");
       print_at(8,4,"Garamond        S536 = 2");
       print_at(8,5,"Garamond        S221 = 3");
       print_at(8,6,"Baskerville     S377 = 4");

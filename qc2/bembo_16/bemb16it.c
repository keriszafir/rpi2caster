/*
       ...
       gensystem       bmbit_06.c
       fixed_spaces


  info testzoek5 in file :
	c:\qc2\bembo16\monoin00.c


  #include <c:\qc2\bembo16\bem_it01.c>  * : wig [] 536... *
  #include <c:\qc2\bembo16\bmbit_06.c> * gegevens matrijzenraam *
  ...
  info matrix 12 point gatamond in file garamond :
...
#include <c:\qc2\bembo_16\bem_it01.c> /* : wig [] 536... */


/*

#include <c:\qc2\last02\ring.c>
...
void _test2_gensystem()
{
    ...
    _dikte[ 0] =  4; _dikte[ 1] =  5; _dikte[ 2] = 6;
    _dikte[ 3] =  7; _dikte[ 4] =  8; _dikte[ 5] = 9;
    _dikte[ 6] = 10; _dikte[ 7] = 11; _dikte[ 8] = 12;
    _dikte[ 9] = 13; _dikte[10] = 14; _dikte[11] = 15;
    _dikte[12] = 16; _dikte[13] = 17; _dikte[14] = 18;
    _dikte[15] = 19; _dikte[16] = 20;
    ...
    wig[0]  =  4; wig[1]  =  5; wig[2]  =  7; wig[3]  =  8;
    wig[4]  =  8; wig[5]  =  9; wig[6]  =  9; wig[7]  =  9;
    wig[8]  =  9; wig[9]  = 10; wig[10] = 11; wig[11] = 12;
    wig[12] = 12; wig[13] = 13; wig[14] = 15;

    for (_test_i = 0; _test_i < 15  ; _test_i += 2) {
       for (_test_j = 0; _test_j < 16 ; _test_j ++) {
	   gen_system(  _test_j,       /* kolom 0-16 */
			_test_i,       /* rij   0-15 */
			(float) _dikte[ _test_j] /* width char */
		 );
       }
    }
...
#include <c:\qc2\bembo_16\bmbit_06.c> /* gegevens matrijzenmcraam */
       /*was: c:\qc2\caslon .... stripc\monobai6/c fx*/


#include <c:\qc2\bembo_16\monoinc7.c>  /* intro intro1 */

#include <c:\qc2\bembo_16\monoinc8.c>
#include <c:\qc2\bembo_16\moninc10.c>
#include <c:\qc2\bembo_16\monolus.c>
...
void calc_maxbreedte ( void )
{
   ...
   if (central.cset <= 48 ) {
      maxbreedte +=
      ( (float) (line_data.nspaces*2-6))*((float) central.cset)/5184.;
   } else {
      maxbreedte +=
      ( (float) (line_data.nspaces  -6))*((float) central.cset)/5184.;
   }
   if (line_data.rs > 0 )
...
#include <c:\qc2\bembo_16\bemb__00.c>
	  /* testzoek5() */
